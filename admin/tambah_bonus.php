...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Bonus (nama_bonus, jumlah_bonus) VALUES ('$nm_bonus', '$jumlah_bonus')";
    if ($conn->query($sql) === TRUE) {
        $status = "Bonus baru berhasil ditambahkan";
...
<div class="flex flex-col lg:flex-row">
    ...
    <div class="container mx-auto lg:w-4/5">
        ...
        <?php endif; ?>
        <h2 class="text-3xl font-bold mb-4 p-4">Tambah Bonus</h2>
        <form action="" method="POST" class="px-4 w-2/5">
            <div class="mb-2">
                ...
                <input type="text" class="mt-1 block w-full px-2 py-2 border border-black rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" name="nm_bonus" required>
            </div>
            <div class="mb-4">
                <label for="jumlah_bonus" class="block text-sm font-medium text-gray-700">Jumlah Bonus</label>
                <input type="number" class="mt-1 block w-full px-2 py-2 border border-black rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" name="jumlah_bonus" required>
            </div>
